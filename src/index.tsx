...
export const USAMapSelect = ({
  ...
  return (
    ...
    >
      <g>
        {usaState && (
          <text x='50%' y='5%' className={stateTextClassname} fill={colorVariants()[USAStateTextColor]}>
            {usaState}
          </text>
        )}
        <path
          ...
          className={`${hoverColorVariants()[USAStateOnHoverColor]} ${
        ...
        <g>
          ...
          <circle
            ...
            onMouseEnter={handleMouseEnter}
            onMouseLeave={handleMouseLeave}
            className={`${colorVariants()[USAStateColor]}  
                        ${hoverColorVariants()[USAStateOnHoverColor]}
                        ${hoverColorVariants(true)[USAStateOnHoverStrokeColor]}
                        hover:cursor-pointer`
            }
            stroke='#FFFFFF'
