  ...
  >
   <g>
    ...
    <path
     ...
     className={`${onHoverUSAStateColor} ${onHoverUSAStateStrokeColor} hover:cursor-pointer`}
    ...
    <g>
     ...
     <circle
      ...
      className={`${colorVariants()[USAStateColor]}  
                        ${onHoverUSAStateColor}
                        ${onHoverUSAStateStrokeColor}
