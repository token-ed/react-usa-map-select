...
const colorVariants = (getStrokeColor?: boolean) => ({
  slate: getStrokeColor
    ? 'hover:stroke-2 hover:stroke-slate-800'
    : 'hover:fill-slate-800',
  white: getStrokeColor
    ? 'hover:stroke-2 hover:stroke-neutral-200'
    : 'hover:fill-neutral-200',
  gray: getStrokeColor
    ? 'hover:stroke-2 hover:stroke-gray-600'
    : 'hover:fill-gray-600',
...
interface Props {
  ...
  USAStateOnHoverColor?: keyof ReturnType<typeof colorVariants>;
  USAStateOnHoverStrokeColor?: keyof ReturnType<typeof colorVariants>;
...
export const USAMapSelect = ({
  ...
  return (
    ...
    >
      <g>
        {usaState && (
          <text x="50%" y="5%" className={stateTextClassname}>
            {usaState}
          </text>
        )}
        <path
          ...
          className={`${colorVariants()[USAStateOnHoverColor]} ${
            colorVariants(true)[USAStateOnHoverStrokeColor]
